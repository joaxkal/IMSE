...
if not database_is_empty():
    #in this way we check if the database exists
    print("DATABASE NOT EMPTY")
else:
    # if the db does not exist then create it and fill with mock data
    print("FILLING DB WITH MOCK DATA")
    db.drop_all()
    db.create_all()
    ...
    # Create categories, posts and comments
    k = 0
    c = 0
